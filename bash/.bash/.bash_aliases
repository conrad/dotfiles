...
alias mockfog='cd ~/thirdwave/docker/fog/ops/mock && docker-compose down && docker-compose up --build -d'
alias fastmock='cd ~/thirdwave/docker/fog/ops/mock && docker-compose down && docker-compose up -d'
